...
export default defineNuxtConfig({
  ...
  alias: {
    ...
    '#alias-special-child-dot': fileURLToPath(new URL('./app_16_special_child_dot', import.meta.url)),
    ...
    '#alias-bmi-calculation': fileURLToPath(new URL('./app_93_bmi_calculation', import.meta.url)),
  },
